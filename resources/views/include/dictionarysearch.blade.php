<div class="col-md-12" align="center" >
    ...
    <form action="{{url('lookup')}}" method="get">
        ...
        <div class="input-group">
            ...
            <a href="{{url('lookup')}}" type="submit" value="Search">
        ...
        {{--            <a target="_blank" href="{{url('lookup')}}">Random Search<span style="color: orange">&nbsp;<i class="glyphicon glyphicon-new-window"></i></span></a>--}}
        {{--</div>--}}
    </form>
</div>